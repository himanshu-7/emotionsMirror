"""
This python script is directly implemented from : https://github.com/DexterInd/GoogleVisionTutorials
(Maintaining the same headers as them)
...
##    takephoto() # First take a picture
    ...
    with open(''put filename with complete path here'', 'rb') as image:
